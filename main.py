...
def parse_args():
    ...
    parser.add_argument('--config', help='test config file path', default='configs/siam_swin/bit_upernet_swin_sub_tiny_patch4_window7_512x512_160k_s2looking_trainval_pretrain_224x224_1K.py')
    parser.add_argument('--checkpoint', help='checkpoint file',
            default='work_dirs/bit_upernet_swin_sub_tiny_patch4_window7_512x512_160k_s2looking_trainval_pretrain_224x224_1K/20210909_100719/iter_160000.pth')
    parser.add_argument(
